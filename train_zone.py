...
import os
from database import DataBaseInput as DBI
from database import DataBaseOutput as DBO
...
DBI(features=features).features_to_db()
...
DBI(clean_train_desc=clean_train_desc).captions_to_db()
# print("clean_train_desc =", clean_train_desc)
train_features = load_features(train_img, features)
...
DBI(tokenizer=tokenizer).tokenizer_to_db()
...
def define_model(vocab_size, max_length):
    ...
    seq3 = LSTM(256, recurrent_activation='sigmoid')(seq2)
